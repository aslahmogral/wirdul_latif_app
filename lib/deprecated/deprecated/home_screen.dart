...
import 'package:wirdul_latif/utils/curve.dart';
import 'package:wirdul_latif/deprecated/wird_model.dart';
import 'package:wirdul_latif/deprecated/provider/wird_provider.dart';
import 'package:wirdul_latif/deprecated/deprecated/intro_outro_msg.dart';
import 'package:wirdul_latif/utils/colors.dart';

class HomeScreendeprecated extends StatefulWidget {
  final List<WirdModel>? wirdList;
  const HomeScreendeprecated({super.key, required this.wirdList});

  @override
  State<HomeScreendeprecated> createState() => _HomeScreendeprecatedState();
}

class _HomeScreendeprecatedState extends State<HomeScreendeprecated> {
  @override
